...
В этом проекте для готового дизайна и UI по ТЗ из оригинального описания написал механику игры.

Для тестирования и развлечения оставил следующие читы:
- «q» — устанавливает здоровье всех персонажей игрока на 1
- «w» — устанавливает здоровье всех персонажей компьютера на 1
- У лучников игрока дальность — все поле

Сборка  
https://nirastor.github.io/ajs-10-diploma/
